...
public final class V1V2TableUtil {
    ...
    private static final String THIS_CLASSNAME = V1V2TableUtil.class.getName();
    ...
    public static InputFormat<PrimaryKey, Row> getInputFormat(
        ...
        if (tablePaths == null || tablePaths.length == 0) {
            ...
            LOG2.debug("FileInputFormat.getInputPaths returned " +
                          (tablePaths == null ? "NULL" : "zero length array"));
            if (inputSplit != null) {
        ...
        LOG2.debug("tablePaths[0] = " + tablePaths[0]);

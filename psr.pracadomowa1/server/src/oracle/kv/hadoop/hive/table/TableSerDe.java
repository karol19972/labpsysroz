...
public class TableSerDe extends TableSerDeBase {
    ...
    private static final String THIS_CLASSNAME = TableSerDe.class.getName();
    ...
    protected void validateParams(Properties tbl) throws SerDeException {
        ...
        LOG2.debug("KV Store Table Name = " + getKvTableName());
        ...
        LOG2.debug("KV Store Field Names = " + fieldNames);
        ...
        LOG2.debug("HIVE Column Names = " + columnNames);
        ...
        LOG2.debug("HIVE Column Types = " + columnTypes);
    ...
    public Object deserialize(Writable field) throws SerDeException {
        ...
        LOG2.debug("deserialize field = " + field);
        ...
        if (LOG2.isDebugEnabled()) {
            LOG2.debug("Row to deserialize:\n" + kvRow);
            LOG2.debug("RecordDef of Row to deserialize:\n" + recDef);
        }
        ...
        for (String fieldName : kvRow.getFieldNames()) {
            ...
            LOG2.debug("field name:value = " + fieldName + ":" + fieldValue);
            ...
            } else if (oi instanceof JavaHiveDecimalObjectInspector) {

                hiveRow.add(
                  ((JavaHiveDecimalObjectInspector) oi).getPrimitiveJavaObject(
                                                            fieldValue));
    ...
    public Writable serialize(Object obj, ObjectInspector objectInspector)
        ...
        LOG2.debug("obj = " + obj + ", objectInspector = " +
                   objectInspector.getClass().getSimpleName());
    ...
    private ObjectInspector objectInspector(
        ...
        case NUMBER:
            return new TableNumberObjectInspector();
    ...
    private ObjectInspector objectInspector(FieldDef fieldDef) {
        ...
        LOG.debug("fieldDef = " + fieldDef.getClass().getSimpleName() +
                  ", fieldType = " + fieldType);
        LOG2.debug("fieldDef = " + fieldDef.getClass().getSimpleName() +
                   ", fieldType = " + fieldType);
        ...
        case JSON:
            return new TableJsonObjectInspector();
        ...
        case TIMESTAMP:
            return new TableTimestampObjectInspector();

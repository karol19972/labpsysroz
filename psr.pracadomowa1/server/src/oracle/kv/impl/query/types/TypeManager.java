...
public class TypeManager {
    ...
    static final ExprType TIMESTAMP_TYPES_ONE[] =
        new ExprType[FieldDefImpl.timestampDefs.length];

    static {
        for (int i = 0; i < FieldDefImpl.timestampDefs.length; i++) {
            TIMESTAMP_TYPES_ONE[i] =
                new ExprType(FieldDefImpl.timestampDefs[i],
    ...
    {
        {
            new ExprType(FieldDefImpl.emptyDef, Quantifier.ONE, true)
        },
        {

...
public class ExprInOp extends Expr {
     ...
     */
    void addDataArgs(ArrayList<Expr> exprs) {
    ...
    boolean isDuplicateKey(ArrayList<Expr> args) {
        ...
        while (k < theArgs.size()) {
            ...
            for (j = 0; j < theNumKeyComps; ++j) {
                ...
                CompOpIter.compare(null, v1, v2, FuncCode.OP_EQ, res,
                                   theLocation);
    ...
    void addArg(int i, Expr newExpr) {
        theArgs.add(i, newExpr);
        newExpr.addParent(this);
    }

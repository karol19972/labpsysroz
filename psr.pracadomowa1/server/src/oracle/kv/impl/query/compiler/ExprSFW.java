...
public class ExprSFW extends Expr {
            ...
            for (i = 0; i < theNumGroupExprs; ++i) {
                ...
                if (k == numGBArgs && firstMatch >= 0) {
                    ...
                    if (fieldOpsExpr != null && exprOps != null) {
                        ...
                        fieldOpsExpr.setValue(FieldDefImpl.stringDef.
                                              createString(newOps));
                    }
                }
            } // for each gb expr
     ...
     * - The given mulit-key index has been select for use by the query.
    ...
    void optimizeMKIndexSizeCall(IndexImpl index) {
        ...
        if (addOuterSFW) {
            ...
            outerSFW.addSelectClause(theFieldNames, outerFieldExprs);
            topExpr = outerSFW;
        }
    ...
    ExprType computeType() {
        ...
        if (numFields == 1 && theIsSelectStar) {
            ...
            assert(fieldType.isRecord() && !fieldExpr.mayReturnNULL());

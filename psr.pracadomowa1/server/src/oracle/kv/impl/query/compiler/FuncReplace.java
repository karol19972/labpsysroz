...
public class FuncReplace extends Function {
    ...
    Expr normalizeCall(ExprFuncCall fncall) {
        ...
        Expr strCastExpr1 = ExprCast.create(fncall.getQCB(), fncall.getSctx(),
                                            fncall.getLocation(),
                                            fncall.getArg(0),
                                            FieldDefImpl.stringDef,
                                            ExprType.Quantifier.STAR);
        fncall.setArg(0, strCastExpr1, false);

        Expr strCastExpr2 = ExprCast.create(fncall.getQCB(), fncall.getSctx(),
                                            fncall.getLocation(),
                                            fncall.getArg(1),
                                            FieldDefImpl.stringDef,
                                            ExprType.Quantifier.STAR);
        ...
        if (numArgs == 3) {
            Expr strCastExpr3 = ExprCast.create(fncall.getQCB(), fncall.getSctx(),
                                                fncall.getLocation(),
                                                fncall.getArg(2),
                                                FieldDefImpl.stringDef,
                                                ExprType.Quantifier.STAR);
            fncall.setArg(2, strCastExpr3, false);
        }

 ...
 * within the input tuples. In this case, thr GroupIter has to actually
...
public class ExprGroup extends Expr {
    ...
    void addFields(ArrayList<Expr> exprs) {

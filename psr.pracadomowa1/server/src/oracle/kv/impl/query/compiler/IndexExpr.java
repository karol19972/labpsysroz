...
class IndexExpr {
    ...
    private void reverseSteps() {
        ...
        if (theInnerCtxVarPos >= 0) {
            theInnerCtxVarPos = theSteps.size() - theInnerCtxVarPos - 1;
        }
    }
        ...
        while (expr != null) {
            ...
            case VAR: {
                ...
                case CTX_ELEM: {
                    ...
                    if (epath.theInnerCtxVarPos < 0) {
                        epath.theInnerCtxVarPos = epath.theSteps.size();
                    }

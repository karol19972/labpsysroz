...
public class FuncTrim extends Function {
    ...
    Expr normalizeCall(ExprFuncCall fncall) {
        ...
        Expr strCastExpr = ExprCast.create(fncall.getQCB(),
                                           fncall.getSctx(),
                                           fncall.getLocation(),
                                           fncall.getArg(0),
        ...
        if (numArgs >= 2) {
            Expr whereCastExpr1 = ExprCast.create(fncall.getQCB(),
                                                  fncall.getSctx(),
                                                  fncall.getLocation(),
                                                  fncall.getArg(1),
                                                  FieldDefImpl.stringDef,
                                                  ExprType.Quantifier.STAR);
            fncall.setArg(1, whereCastExpr1, false);
        }

        if (numArgs == 3) {
            Expr trimCharCastExpr2 = ExprCast.create(fncall.getQCB(),
                                                     fncall.getSctx(),
                                                     fncall.getLocation(),
                                                     fncall.getArg(2),
                                                     FieldDefImpl.stringDef,
                                                     ExprType.Quantifier.STAR);
            fncall.setArg(2, trimCharCastExpr2, false);
        }

...
public class SortIter extends PlanIter {
    ...
    private class CompareFunction implements Comparator<FieldValueImpl> {
        ...
        public int compare(FieldValueImpl v1, FieldValueImpl v2) {
            ...
            return compareAtomics(v1, v2, 0, theSortSpecs);
        }
    }
    ...
    static int compareRecords(
        ...
        for (int i = 0; i < sortFieldPositions.length; ++i) {
            ...
            int comp = compareAtomics(v1, v2, i, sortSpecs);
    ...
    static int compareAtomics(
        ...
        /*
         * order among special values:
         * ASC  --> EMPTY, JNULL, NULL
         * DESC --> NULL, JNULL, EMPTY
         */
        ...
        int comp = FieldValueImpl.compareKeyValues(v1, v2, true);

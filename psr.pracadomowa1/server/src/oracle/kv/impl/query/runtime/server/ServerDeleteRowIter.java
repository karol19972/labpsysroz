...
public class ServerDeleteRowIter extends DeleteRowIter {
    ...
    public void open(RuntimeControlBlock rcb) {
        ...
        if (ri != null && ri.getGBTuple() != null) {
            theNumDeleted = ri.getGBTuple()[0].asLong().get();
        }
    }
    ...
    public boolean next(RuntimeControlBlock rcb) {
        ...
        FieldValueImpl numDeletedVal =
            FieldDefImpl.longDef.createLong(theNumDeleted);

        if (rcb.getReachedLimit()) {

            FieldValueImpl[] gbTuple = new FieldValueImpl[1];
            gbTuple[0] = numDeletedVal;
            rcb.getResumeInfo().setGBTuple(gbTuple);
            state.done();
            return false;
        }
    ...
    private void deleteRow(RuntimeControlBlock rcb) {
        ...
        /*
         * Configure the ThroughputTracker of Delete op with the
         * ThroughputTracker of TableQuery.
         */
        op.setThroughputTracker(theQueryOp);

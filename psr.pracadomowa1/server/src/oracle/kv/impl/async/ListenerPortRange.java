...
public class ListenerPortRange {
    ...
    /**
     * A port range that for any interface and any port to listen on.
     */
    public static final ListenerPortRange ANY_LOCAL_PORT_RANGE =
     ...
     */
    public ListenerPortRange(@Nullable String hostname,
                             int portStart,
                             int portEnd)

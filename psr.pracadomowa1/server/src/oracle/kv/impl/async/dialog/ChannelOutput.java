...
public class ChannelOutput {
    ...
    private final String createChunkSliceDescription = String.format(
        "create chunk scatter slice from pool for channel output %x",
        System.identityHashCode(this));
    private final String forkScatterSliceDescription = String.format(
        "fork slice to add scatter data for channel output %x",
        System.identityHashCode(this));
    ...
    public class Chunk {
        ...
        public Chunk(int maxScatterSize, boolean last) {
            this.sliceForScatter =
                IOBufSliceImpl.OutputPoolBufSlice.createFromPool(
                    pool, createChunkSliceDescription);
        ...
        private void addBuf() {
            ...
            outputs.add(sliceForScatter.forkBackwards(
                pos - addBufPos, forkScatterSliceDescription));
            addBufPos = pos;
        }
    }

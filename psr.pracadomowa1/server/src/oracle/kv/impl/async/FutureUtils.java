...
public class FutureUtils {
     ...
     */
    private static @Nullable Throwable unwrapException(@Nullable Throwable e) {
    ...
    {
        return (t, e) -> function.apply(t, unwrapException(e));
    }
    ...
    {
        return e -> function.apply(unwrapException(e));
    }
    ...
    {
        return (t, e) -> consumer.accept(t, unwrapException(e));
    }
     ...
     * @return the translated RuntimeException
     */

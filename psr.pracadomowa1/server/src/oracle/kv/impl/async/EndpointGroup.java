...
public interface EndpointGroup {
     ...
     * @param localAddress the network address of the local endpoint. Use
     * {@link NetworkAddress#ANY_LOCAL_ADDRESS} to specify no preference so
     * that any network interface and any port can be used.
     ...
     */
    EndpointGroupPerfTracker getEndpointGroupPerfTracker();
    ...
    public interface ListenHandle {
         ...
         *
         * @return the network address the listener is listening on
         */

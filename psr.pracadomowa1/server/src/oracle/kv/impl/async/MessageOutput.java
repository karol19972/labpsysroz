...
public class MessageOutput implements DataOutput {
    ...
    /* Buf slice creation descriptions */
    private static final String CREATE_SCATTER_SLICE_DESCRIPTION =
        "create scatter slice from pool for message output";
    private static final String FORK_FRAME_SLICE_DESCRIPTION =
        "fork frame slice for message output";
    private static final String FORK_SCATTER_SLICE_DESCRIPTION =
        "fork scatter data slice for message output";
    ...
    public MessageOutput(IOBufferPool pool) {
        ...
        this.sliceForScatter =
            IOBufSliceImpl.OutputPoolBufSlice.createFromPool(
                pool, CREATE_SCATTER_SLICE_DESCRIPTION);
     ...
     * called for this message output.
     */
    public void discard() {
    ...
    public Queue<IOBufSliceList> pollFrames(int frameSize) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                frame.add(slice.forkAndAdvance(
                    inc, FORK_FRAME_SLICE_DESCRIPTION));
                size += inc;
            }
            slice.markFree();
        }
    ...
    private void appendBufferedToOutput() {
        ...
        outputs.add(sliceForScatter.forkBackwards(
            currpos - pos, FORK_SCATTER_SLICE_DESCRIPTION));

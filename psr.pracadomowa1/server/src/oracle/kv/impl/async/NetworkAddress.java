...
public class NetworkAddress extends SocketAddress
     ...
     */
    public static final NetworkAddress ANY_LOCAL_ADDRESS =
    ...
    /**
     * Converts an InetSocketAddress to a NetworkAddress. If the argument is
     * null, returns {@link #ANY_LOCAL_ADDRESS}.
     */
    public static NetworkAddress convert(@Nullable InetSocketAddress address) {
        return (address == null) ?
            NetworkAddress.ANY_LOCAL_ADDRESS :
            new NetworkAddress(address.getHostString(), address.getPort());
    }

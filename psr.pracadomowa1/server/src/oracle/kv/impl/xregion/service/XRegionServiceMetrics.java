...
public class XRegionServiceMetrics extends JsonMetricsHeader
    ...
    public XRegionServiceMetrics(String agentId, String localRegion) {
    ...
    @JsonIgnore
    @Override
    public Map<String, MetricStats> getLaggingMs() {
        final Map<String, MetricStats> ret = new HashMap<>();
    ...
    @JsonIgnore
    @Override
    public Map<String, MetricStats> getLatencyMs() {
        final Map<String, MetricStats> ret = new HashMap<>();

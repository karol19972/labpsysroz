...
public class XRegionStatistics {
     ...
     */
    public void removeTableMetrics(@NonNull String table) {
     ...
     */
    public void addTableMetrics(@NonNull MRTableMetrics metrics) {
     ...
     */
    public Set<MRTableMetrics> getAllTableMetrics() {

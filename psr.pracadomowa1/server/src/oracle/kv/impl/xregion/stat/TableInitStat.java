...
public class TableInitStat implements Serializable {
     ...
     */
    public static final long NOT_START_TIME_MS = 0;
    /**
     * time in ms representing complete time while transfer incomplete
     */
    public static final long NOT_COMPLETE_TIME_MS = 0;

    /**
     * source region name
     */
    private volatile String region = "REGION_UNSET";
    /**
    ...
    /**
     * # of rows transferred from source in initialization
     */
    ...
    public synchronized void incrTransferred(long delta) {
        transferRows += delta;
    }

    public synchronized void incrPersisted(long delta) {
        persistRows += delta;
    }

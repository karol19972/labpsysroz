...
public class RegionAgentConfig {
    ...
    /*
     * True if table scan is needed when it is added to a running stream in
     * agent. In V1 only new Multi-region table can be added to the agent,
     * thus there is no need to scan the table, default is false.
     */
    private final boolean initTableRequired = false;
    ...
    /**
     * Returns true if initializing table is needed when adding a table to
     * the agent, otherwise false.
     *
     * @return true if initializing table is needed when adding a table to
     * the agent, otherwise false.
     */
    boolean initTableRequired() {
        return initTableRequired;
    }
    ...
    public static class Builder {
        ...
        /* # concurrent stream ops */
        private int numConcurrentStreamOps;
         ...
         * positive
         */
        public Builder setCkptIntvOps(long ckptIntvOps) {
            if (ckptIntvOps <= 0) {
                throw new IllegalArgumentException(

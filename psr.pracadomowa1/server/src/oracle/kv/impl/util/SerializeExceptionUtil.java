...
public class SerializeExceptionUtil {
     ...
     * <li> ({@link #writeStackTrace}) <i>stack trace, for serial version
     *      {@link SerialVersion#ASYNC_EXCEPTION_STACKTRACE_VERSION} and
     *      greater</i>
     * </ol>
     *
    ...
    /**
     * Writes an exception's stack trace to the output stream. If the serial
     * version is less than {@link
     * SerialVersion#ASYNC_EXCEPTION_STACKTRACE_VERSION}, writes nothing.
     * Otherwise, writes:
     * <ol>
    ...
    public static void writeStackTrace(DataOutput out,
        ...
        if (serialVersion < SerialVersion.ASYNC_EXCEPTION_STACKTRACE_VERSION) {
            return;
        }
    ...
    /**
     * Reads exception stack trace elements from the input stream. Returns null
     * if the serial version is less than {@link
     * SerialVersion#ASYNC_EXCEPTION_STACKTRACE_VERSION}.
     */

...
/**
 * Low-level support for serializing values.
 * <p/>
...
public abstract class Encoder implements Flushable {
     ...
     * 
     * @throws IOException
     *             If this is a stateful writer and a null is not expected
     */
     ...
     * @throws IOException
     */
    public abstract void writeFixed(byte[] bytes, int start, int len)
            throws IOException;
     ...
     * can call any {@link Encoder} method (e.g., {@link #writeLong}). When all
     * items of the array have been written, call {@link #writeArrayEnd}.
     *
     ...
     * 
     * @throws IOException
     *             If this is a stateful writer and an array is not expected
     */
     ...
     * other write methods of {@link Encoder}. The number of calls to
     ...
     * 
     * @throws IOException
     *             If called outside of an array or map context
     */

...
public class ResolvingGrammarGenerator extends ValidatingGrammarGenerator {
    ...
    private static EncoderFactory factory = new EncoderFactory()
            .configureBufferSize(32);
    ...
    private static void encodeNullable(Encoder encoder, FieldMapEntry fme,
    ...
    private static void encode(Encoder e, FieldDefImpl s, FieldValueImpl n)
            throws IOException {
        switch (s.getType()) {
        case RECORD:

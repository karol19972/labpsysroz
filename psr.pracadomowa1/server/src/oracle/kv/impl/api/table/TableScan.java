...
public class TableScan {
    ...
    static AsyncTableIterator<Row>
        ...
        if (iterateOptions != null) {
            ...
            options.setLogContext(iterateOptions.getLogContext());
            options.setAuthContext(iterateOptions.getAuthContext());
        }
        ...
        if (key.getMajorKeyComplete()) {
            return createPartitionRowIterator(
                apiImpl, params, key, targetTables, iterHandleNotifier,

...
import static oracle.kv.impl.util.SerialVersion.ALTER_MULTI_REGION_TABLE;
...
public final class CommandServiceAPI extends RemoteAPI {
    ...
    public int createEvolveTablePlan(String planName,
        ...
        if (regions != null) {
            checkMethodSupported(ALTER_MULTI_REGION_TABLE);
        }
        ...
        if (serialVersion < ALTER_MULTI_REGION_TABLE) {
   ...
   /**
    ...
    public VerificationInfo startAndPollVerify(VerificationOptions options,
                                               int planId)
        throws RemoteException {
        checkMethodSupported(SerialVersion.UPGRADE_VERIFY_DATA_VERSION);

...
public class Admin
     ...
     */
    private final KVVersion MIN_UTIL_THREAD_VERSION = KVVersion.R18_1;
    ...
    private void shutdownThreads(boolean force) {
        ...
        synchronized (threadLock) {
            ...
            if (closing) {
                ...
                mrtServiceManager.shutdown(force);
            }
        }
    }
    ...
    public static class Memo implements Serializable {
        ...
        public Memo(int firstPlanId, LatestEventTimestamps let) {
            planId = firstPlanId;
        ...
        synchronized(internalKVStoreLock) {
            ...
            try {
                final RequestDispatcherImpl requestDispatcher =
                    RequestDispatcherImpl.createForClient(config, randomId,
                                                          getLoginManager(),
                                                          exceptionHandler,
                                                          logger);
                kvstore = KVStoreInternalFactory.getStore(config,
                                                          requestDispatcher,
                                                          getLoginManager(),
                                                          logger);
                return kvstore;

...
public class SSLConfig {
    ...
    private SSLContext makeSSLContext(SSLAuthInfo authInfo, boolean isServer)
        ...
        try {
            ...
            if (authInfo.keyStore != null &&
                ...
                final KeyManagerFactory kmf = makeSSLKeyManagerFactory();
            ...
            if (authInfo.trustStore != null) {
                ...
                loadKeystore(ts, new FileInputStream(authInfo.trustStore), tsPw);
    ...
    /*
     * Load Java KeyStore from a file input stream. This method would close the
     * input stream after KeyStore has been loaded.
     */

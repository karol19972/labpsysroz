...
public class SystemPrivilege extends KVStorePrivilege {
    ...
    static {
        ...
        sysPrivilegeMap.put(WRITE_SYSTEM_TABLE.getLabel(), WRITE_SYSTEM_TABLE);
        ...
        sysPrivilegeMap.put(CREATE_ANY_REGION.getLabel(), CREATE_ANY_REGION);
        sysPrivilegeMap.put(DROP_ANY_REGION.getLabel(), DROP_ANY_REGION);
    }

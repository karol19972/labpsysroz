...
public class KVStoreConfig implements Serializable, Cloneable,
    ...
    /**
     * The default maximum number of endpoints that the KVStats monitor should
     * log. An Endpoint is a shared handle which manages all connections to the
     * same remote address with the same configuration.
     *
     * @hidden Until statistics monitoring is made public
     */
    public static final int DEFAULT_STATS_MONITOR_MAX_NUM_ENDPOINTS =
        Integer.MAX_VALUE;
    ...
    /* The KVStats monitor log maximum number of endpoints */
    private int statsMonitorMaxNumEndpoints =
        DEFAULT_STATS_MONITOR_MAX_NUM_ENDPOINTS;
    ...
    */
    ...
    /**
     * Sets the maximum number of endpoints to log for the KVStats monitor.  An
     * Endpoint is a shared handle which manages all connections to the same
     * remote address with the same configuration.  The KVStats monitor logs
     * detailed metrics for each endpoint connecting to the store. The maximum
     * number of endpoints to log can be limited by this configuration. The
     * default value is {@value #DEFAULT_STATS_MONITOR_MAX_NUM_ENDPOINTS}. The
     * KVStats monitor must be {@link #setEnableStatsMonitor enabled} for
     * this configuration to have effect.
     *
     * @hidden Until statistics monitoring is made public
     */
    public KVStoreConfig setStatsMonitorMaxNumEndpoints(int value) {
        this.statsMonitorMaxNumEndpoints = value;
        return this;
    }

    /**
     * Returns the maximum number of endpoints to log for the KVStats monitor.
     *
     * @hidden Until statistics monitoring is made public
     */
    public int getStatsMonitorMaxNumEndpoints() {
        return statsMonitorMaxNumEndpoints;
    }

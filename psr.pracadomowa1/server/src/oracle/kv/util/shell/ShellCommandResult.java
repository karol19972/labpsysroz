 ...
 * ObjectNode from "com.fasterxml.jackson.databind.node" implementation of JSON.
 * Below is an example of converting between ObjectNode and string:
 * <pre>
...
public class ShellCommandResult {
    ...
    public static ShellCommandResult filterJsonV1Result(String input)
        ...
        if (returnValue != null) {
            ...
            final Iterator<Entry<String, JsonNode>> iter =
                convertedNode.fields();
            /* merge return value fields with v1 result fields */
            while(iter.hasNext()) {
                final Entry<String, JsonNode> entry = iter.next();
                v1Result.set(entry.getKey(), entry.getValue());
            }
        }
    ...
    private static ObjectNode
        ...
        final Iterator<Entry<String, JsonNode>> iter = v1Node.fields();
        while(iter.hasNext()) {
            final Entry<String, JsonNode> entry = iter.next();
    ...
    private static ArrayNode
        ...
        final Iterator<JsonNode> iter = v1Node.elements();
        while(iter.hasNext()) {

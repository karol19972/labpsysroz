...
public class AdminSNRecover {
    ...
    static class ShardName {
        ...
        public ShardName(String shardName) {
        ...
        public boolean equals(final Object object) {
            ...
            if (!(object instanceof ShardName)) {
                return false;
            }
            final ShardName other = (ShardName) object;
            return Objects.equals(shardName, other.shardName);
        }

        @Override
        public int hashCode() {
            int hash = 71;
            hash = (73 * hash) + Objects.hashCode(shardName);
            return hash;
        }
    }

...
public class SubscriptionChangeNotAppliedException extends RuntimeException {
    ...
    public enum Reason {
        ...
        /**
         * The server could not apply the change because the change has already
         * been made by an earlier request, and thus the change in the request
         * is redundant and has no impact to subscription.
         */
        SERVER_COULD_NOT_APPLY,

...
public interface Row extends RecordValue {
    ...
    /**
     * Returns the last update time of the row. The update time is
     * valid if this row was returned by a get (e.g. {@link TableAPI#get}) or
     * table iterator (e.g. {@link TableAPI#tableIterator}) call. It will
     * also be valid after a successful put of the row
     * (e.g. {@link TableAPI#put}.
     *
     * @return the last update time in milliseconds since January 1, 1970.
     *
     * @throws UnsupportedOperationException if modification time is not
     * available, which will occur in following cases:
     * <ul>
     * <li>The record is written in an old version prior to 19.5.
     * <li>The Choice of ReturnRow is VERSION or NONE.
     * </ul>
     *

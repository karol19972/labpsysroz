...
public interface TableAPI {
     ...
     * user specified value is used for the call. For an IDENTITY GENERATED
     * ALWAYS column, the row must not contain an entry, otherwise an
     * IllegalArgumentException is thrown. When the GENERATED ALWAYS
     * IDENTITY column is also part of the primary key a SQL UPDATE is
     * required for updating the other values of the row.</p>
     *

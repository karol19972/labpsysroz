...
public class ExtinctionScanner implements EnvConfigObserver {
     ...
     * temporary DBs or when the database creation is undone by either
     * aborting the transaction that created it or undoing an unresolved
     * transaction in recovery. We cannot perform utilization counting
     * synchronously(in the app operation thread) because it could cause
     * timeouts, most importantly during replica replay. Therefore, a record
     * is added to the scan DB and the database extinction is performed
     * asynchronously, like record extinction.
     *

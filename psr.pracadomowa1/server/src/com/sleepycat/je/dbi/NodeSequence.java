...
public class NodeSequence {
    ...
    /*
     * Transient LSNs are used for not-yet-logged DeferredWrite records.
     * Transient LSNs are used to provide unique locks, and are only used
     * during the life of an environment, for non-persistent objects.
     */

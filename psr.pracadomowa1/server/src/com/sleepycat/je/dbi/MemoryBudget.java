...
public class MemoryBudget implements EnvConfigObserver {
    ...
    // 36
    // 32b JDK 1.7 is 928
    private final static int MAPLN_OVERHEAD_32 = 456; // used OOPs value
    private final static int MAPLN_OVERHEAD_64 = 696;
    private final static int MAPLN_OVERHEAD_OOPS = 456;

    // 9
    private final static int LN_OVERHEAD_32 = 40; // used OOPS value
    ...
    // 12
    private final static int BIN_FIXED_OVERHEAD_32 = 240; // used OOPS value
    ...
    // 13
    private final static int IN_FIXED_OVERHEAD_32 = 264; // used OOPs value
    ...
    // 33
    private final static int LN_INFO_OVERHEAD_32 = 48; // used OOPS values

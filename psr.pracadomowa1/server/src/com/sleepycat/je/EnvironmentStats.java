 ...
 *
 * <h3><a id="cache">Cache Statistics</a></h3>
 *
 ...
 *
 * <h4><a id="cacheSizing">Cache Statistics: Sizing</a></h4>
 *
 ...
 *   </td></tr>
 *  <tr><td>{@link #getOffHeapUtilization}</td>
 *   <td>
 *    {@value com.sleepycat.je.evictor.OffHeapStatDefinition#CACHE_UTILIZATION_DESC}
 *   </td></tr>
 ...
 *
 * <h4><a id="cacheSizeOptimizations">Cache Statistics: Size
 * Optimizations</a></h4>
 *
 ...
 * </ul>
 *
 * <h4><a id="cacheUnexpectedSizes">Cache Statistics: Unexpected
 * Sizes</a></h4>
 *
 ...
 * locks.</p>
 *
 * <h4><a id="cacheEviction">Cache Statistics: Eviction</a></h4>
 *
 ...
 *
 * <h4><a id="cacheCriticalEviction">Cache Statistics: Critical
 * Eviction</a></h4>
 *
 ...
 *
 * <h4><a id="cacheLRUListContention">Cache Statistics: LRU List
 * Contention</a></h4>
 *
 ...
 *
 * <h4><a id="cacheDebugging">Cache Statistics: Debugging</a></h4>
 *
 ...
 * </ul>
 *
 * <h3><a id="cleaner">Cleaning Statistics</a></h3>
 *
 * <p style="margin-left: 2em">Group Name: {@value
 * com.sleepycat.je.cleaner.CleanerStatDefinition#GROUP_NAME}
 * <br>Description: {@value
 ...
 *
 * <h4><a id="cleanerUtil">Cleaning Statistics: Utilization</a></h4>
 *
 ...
 * </ul>
 *
 * <h4><a id="cleanerEfficiency">Cleaning Efficiency</a></h4>
 *
 ...
 *
 * <h4><a id="cleanerProcessing">Cleaning Statistics: Processing
 * Details</a></h4>
 *
 ...
 *
 * <h4><a id="cleanerPending">Cleaning Statistics: Pending LNs and
 * DBs</a></h4>
 *
 ...
 *
 * <h4><a id="cleanerTTL">Cleaning Statistics: TTL and expired data</a></h4>
 *
 ...
 *
 * <h4><a id="cleanerDiskSpace">Cleaning Statistics: Disk Space
 * Management</a></h4>
 *
 ...
 * information.</p>
 *
 * <h3><a id="log">I/O Statistics</a></h3>
 *
 * <p style="margin-left: 2em">Group Name: {@value
 * com.sleepycat.je.log.LogStatDefinition#GROUP_NAME}
 * <br>Description: {@value
 ...
 *
 * <h4><a id="logFileAccess">I/O Statistics: File Access</a></h4>
 *
 ...
 * </ul>
 *
 * <h4><a id="logCritical">I/O Statistics: Logging Critical Section</a></h4>
 *
 ...
 *
 * <h4><a id="logBuffer">I/O Statistics: Log Buffers</a></h4>
 *
 ...
 *
 * <h4><a id="logItemBuffer">I/O Statistics: Log Item Buffers</a></h4>
 *
 ...
 *
 * <h4><a id="logWriteQueue">I/O Statistics: The Write Queue</a></h4>
 *
 ...
 *
 * <h4><a id="logFsync">I/O Statistics: Fsync and Group Commit</a></h4>
 *
 ...
 *
 * <h3><a id="incomp">Node Compression Statistics</a></h3>
 *
 * <p style="margin-left: 2em">Group Name: {@value
 * com.sleepycat.je.incomp.INCompStatDefinition#GROUP_NAME}
 * <br>Description: {@value
 ...
 * </table>
 *
 * <h3><a id="ckpt">Checkpoint Statistics</a></h3>
 *
 * <p style="margin-left: 2em">Group Name: {@value
 * com.sleepycat.je.recovery.CheckpointStatDefinition#GROUP_NAME}
 * <br>Description: {@value
 ...
 * </table>
 *
 * <h3><a id="lock">Lock Statistics</a></h3>
 *
 * <p style="margin-left: 2em">Group Name: {@value
 * com.sleepycat.je.txn.LockStatDefinition#GROUP_NAME}
 * <br>Description: {@value
 ...
 * </table>
 *
 * <h3><a id="throughput">Operation Throughput Statistics</a></h3>
 *
 * <p style="margin-left: 2em">Group Name: {@value
 * com.sleepycat.je.dbi.DbiStatDefinition#THROUGHPUT_GROUP_NAME}
 * <br>Description: {@value
 ...
 * </table>
 *
 * <h3><a id="btreeop">Btree Operation Statistics</a></h3>
 *
 * <p style="margin-left: 2em">Group Name: {@value
 * com.sleepycat.je.dbi.BTreeStatDefinition#BT_OP_GROUP_NAME}
 * <br>Description: {@value
 ...
 * </table>
 *
 * <h3><a id="env">Miscellaneous Environment-Wide Statistics</a></h3>
 *
 * <p style="margin-left: 2em">Group Name: {@value
 * com.sleepycat.je.dbi.DbiStatDefinition#ENV_GROUP_NAME}
 * <br>Description: {@value
 ...
 *
 * <!-- Hidden: For internal use: automatic backups
 * <h3><a id="#backup">Automatic Backup Statistics</a></h3>
 *
 * <p style="margin-left: 2em">Group Name: {@value
 * com.sleepycat.je.dbi.DbiStatDefinition#BACKUP_GROUP_NAME}
 * <br>Description: {@value
...
public class EnvironmentStats implements Serializable {
    ...
    */
    ...
    /**
     * <p>{@value
     * com.sleepycat.je.evictor.OffHeapStatDefinition#CACHE_UTILIZATION_DESC}
     * </p>
     *
     * <p style="margin-left: 2em">Group: {@value
     * com.sleepycat.je.evictor.OffHeapStatDefinition#GROUP_NAME}
     * <br>Name: {@value
     * com.sleepycat.je.evictor.OffHeapStatDefinition#CACHE_UTILIZATION_NAME}
     * </p>
     *
     * <p>This includes the estimated overhead for off-heap memory blocks, as
     * well as their contents.</p>
     *
     * <p>If the off-heap cache is not enabled, the return value is always 0.
     * </p>
     *
     * <p>If this environment uses the shared cache, the return value is the
     * total for all environments that are sharing the cache.</p>
     ...
     * @see <a href="#cacheSizing">Cache Statistics: Sizing</a>
     */
    public long getOffHeapUtilization() {
        return offHeapStats.getInt(OffHeapStatDefinition.CACHE_UTILIZATION);
    }

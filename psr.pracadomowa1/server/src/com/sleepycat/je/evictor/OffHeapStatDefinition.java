...
public class OffHeapStatDefinition {
    ...
    public static final String CACHE_UTILIZATION_NAME =
        "offHeapUtilization";
    public static final String CACHE_UTILIZATION_DESC =
        "The off-heap cache utilization as a percentage of the " +
            "configured max size.";
    public static final StatDefinition CACHE_UTILIZATION =
        new StatDefinition(
            CACHE_UTILIZATION_NAME,
            CACHE_UTILIZATION_DESC,
            StatType.CUMULATIVE);

...
public class ReplicatedEnvironmentStats implements Serializable {
     ...
     * #getTxnAvgNs} to return the average elapsed transaction time.
     */
    @Deprecated
    public long getReplayTxnTime() {
        return 0;
    }
    ...
    /**
     * @deprecated since 19.5. Use {@link #getReplayQueueMaxDelayNs} instead.
    ...
    public long getReplayQueueMaxDelayMs() {
        return TimeUnit.NANOSECONDS.toMillis(getReplayQueueMaxDelayNs());
    }
    ...
    /**
     * @deprecated since 19.5. Use {@link #getReplayQueueAvgDelayNs} instead.
    ...
    public long getOutputQueueAvgDelayMs() {
        return TimeUnit.NANOSECONDS.
            toMillis(replayStats.getLong(OUTPUT_QUEUE_AVG_DELAY_NS));
    }

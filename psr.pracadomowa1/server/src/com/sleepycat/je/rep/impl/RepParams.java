...
public class RepParams {
    ...
    public static final DurationConfigParam ELECTIONS_CLOCK_SKEW =
        new DurationConfigParam(ReplicationConfig.ELECTIONS_CLOCK_SKEW,
                                null,               // min
                                "1 min",            // max
                                "0 s",              // default
                                false,              // mutable
    ...
    /**
     * @deprecated as of 19.5 VLSNs are always preserved.
     */
    @SuppressWarnings("unused")
    @Deprecated
    private static final BooleanConfigParam PRESERVE_RECORD_VERSION =
        new BooleanConfigParam(EnvironmentParams.REP_PARAM_PREFIX +

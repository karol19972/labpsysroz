...
public class NetworkBackup {
    ...
    protected void getFile(final File file)
        ...
        if (!Arrays.equals(messageDigest.digest(), fileEnd.getDigestSHA256())) {
     ...
     * deleted
     */
    private void disposeObsoleteFiles(final File startFile) {
        final File[] dirFiles = fileManager.listJDBFiles();

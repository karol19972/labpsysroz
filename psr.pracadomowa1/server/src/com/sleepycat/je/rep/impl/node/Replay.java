...
public class Replay {
     ...
     * it may have allocated off-heap memory, acquired locks, etc, and these
     * resources must be freed to avoid leaks and deadlocks.
     */
    ...
    public void replayEntry(long startNs,
        ...
        try {
            ...
            if (LOG_TXN_COMMIT.equalsType(entryType)) {
                ...
                repTxn.setMasterCommitTime(commit.getTime());
    ...
    private class GroupCommit {
         ...
         */
        private boolean bufferAck(long nowNs,
                                  ReplayTxn ackTxn,
         ...
         */
        private void flushPendingAcks(long nowNs)
            throws IOException {
    ...
    public static class TxnInfo {
        ...
        private TxnInfo(long txnVLSN, long masterTxnEndTime) {

...
public class Replica {
     ...
     * to release BIN and off-heap memory resources. Any thread removing an
     * entry from the queue must call {@link Replay#closePreprocessor}, which
     * calls {@link ReplayPreprocessor#close}. To clear the queue call
     * {@link #clearReplayQueue}, which calls {@link Replay#closePreprocessor}
     * for each entry.
     */
        ...
        public void run() {
            ...
            try {
                ...
                LoggerUtils.info(logger, repImpl, "Replay thread exiting" +
                    " at txn:" + replay.getLastReplayedTxn() +
                    ", at vlsn:" + replay.getLastReplayedVLSN() +
                    ((exception != null) ?
    ...
    public class ConsistencyTracker {
        ...
        synchronized void trackTxnEnd() {
            ...
            lastReplayedTxnVLSN = lastReplayedTxn.getTxnVLSN();

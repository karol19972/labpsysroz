...
public class ServiceDispatcher extends StoppableThread {
    ...
    private final RateLimitingLogger<String> unknownServiceLogger;
    ...
    public ServiceDispatcher(InetSocketAddress socketAddress,
        ...
        unknownServiceLogger = new RateLimitingLogger<>
    ...
    private void processService(DataChannel channel, String serviceName) {
        ...
        try {
            if (service == null) {
                 ...
                 */
                LoggerUtils.logMsg(unknownServiceLogger, repImpl, serviceName,
                                   Level.INFO,

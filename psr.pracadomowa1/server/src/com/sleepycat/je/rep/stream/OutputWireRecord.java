...
public class OutputWireRecord extends WireRecord {
     ...
     * aborts, which also means that {@link #getCommitTxnId()} and
...
//            logItem.verifyBufferInUse();
    ...
    public boolean getLNEntryInfo(final LNEntryInfo lnInfo) {
        ...
        ((LNLogEntry<?>) instantiateEntry()).getLNEntryInfo(lnInfo);

        // TODO optimize by instead calling:
        //  LNLogEntry.parseEntry(entryBuffer, header.getVersion(), lnInfo);
     ...
     * @throws DatabaseException
     *
     * @deprecated as of 19.5, use {@link #getLNEntryInfo(LNEntryInfo)} and
     * {@link LNEntryInfo#data} instead.
     */

 ...
 * methods.
 *
 * <h1 id="asyncIO">Asynchronous IO operation incompletion and
 * continuation</h1>
 *
 ...
 *
 * <h1 id="flush">Flushing the channel</h1>
 *
 ...
 * is flushed.
 *
 * <h1 id="close">Closing the channel</h1>
 *
...
public interface DataChannel extends ByteChannel,
     ...
     * executor}.
     *
     * The {@code callback} is executed after the tasks are done.
     */
    void executeTasks(ExecutorService executor, Runnable callback);
}

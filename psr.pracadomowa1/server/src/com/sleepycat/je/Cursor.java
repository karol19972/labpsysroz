 ...
 *
 * <h3><a id="partialEntry">Using Null and Partial DatabaseEntry
 * Parameters</a></h3>
 *
...
public class Cursor implements ForwardCursor {
    ...
    OperationResult deleteWithRepContext(final ReplicationContext repContext) {
        return deleteNotify(repContext, null, 0L /*modificationTime*/);
    }
            ...
            if (secondaries != null) {
                ...
                for (final SecondaryDatabase secDb : secondaries) {
                    nWrites += secDb.updateSecondary(
                        ...
                        readResult.isTombstone(), false /*newTombstone*/);
                }
    ...
    OperationResult deleteNoNotify(final CacheMode cacheMode,
        ...
        return deleteNoNotify(cacheMode, 0L /*modificationTime*/, repContext);
    }
    ...
    private OperationResult deleteNoNotify(
        ...
        synchronized (getTxnSynchronizer()) {
            ...
            final OperationResult result = cursorImpl.deleteCurrentRecord(
                modificationTime, repContext, false /*latched*/);
    ...
    OperationResult putForReplay(
        ...
        final WriteParams writeParams = new WriteParams(
            null /*cacheMode*/, preprocessor, repContext,
            lnEntry.getExpiration(), lnEntry.isExpirationInHours(),
            true /*updateExpiration*/, lnEntry.getModificationTime(),
            lnEntry.isTombstone());

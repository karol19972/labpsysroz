...
public class LogManager {
    ...
    private void logItem(final LogItem item, final LogParams params) {
        ...
        if (params.segment != null) {
            ...
            params.segment.put(params.buffer);
        }
        ...
        try {
            ...
            if (bufferSegment != null) {
                ...
                fileManager.writeLogBuffer(
                    new LogBuffer(params.buffer, currentLsn),
                    flushWriteQueue);
    ...
    WholeEntry getLogEntryFromLogSource(long lsn,
         ...
         *
         * TODO: This is temporarily disabled because it is firing in
         * oracle.kv.impl.api.table.JsonTableTest.testJsonTypedIndex. We need
         * to debug this without causing KVS test failures.

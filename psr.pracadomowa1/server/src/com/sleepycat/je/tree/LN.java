...
public class LN extends Node implements VersionedWriteLoggable {
    ...
    /**
     * Initialize LN after fetching from disk or loading from off-heap.
     */
    ...
    public LogItem optionalLog(
        ...
        if (dbImpl.isDeferredWriteMode() && currEmbeddedLN == newEmbeddedLN) {
            setModificationTime(newModificationTime);
    ...
    public LogItem log(
        ...
        return logInternal(
            envImpl, dbImpl, locker, writeLockInfo,
            newEmbeddedLN, newKey, newExpiration, newExpirationInHours,
            newModificationTime, newTombstone, false /*newBlindDeletion*/,
            currEmbeddedLN, currLsn, currSize, isInsertion, backgroundIO,
            repContext);
    }

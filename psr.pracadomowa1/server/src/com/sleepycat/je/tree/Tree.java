...
public final class Tree implements Loggable {
        ...
        try {
            ...
            while (true) {
                ...
                if (!rootExists()) {
                    ...
                    bin.latch(cacheMode);
                    LogItem binLogItem =
                        bin.optionalLogProvisionalNoCompress(rootIN);
        ...
        try {
            ...
            for (int i = nodeLadder.size() - 1; i >= 0; i -= 1) {
                ...
                if (child.needsSplitting()) {
                    ...
                    if (child.isBIN()) {
                        binSibling = newSibling;
                        binResult = findSplitBranch(
                            parent, key, comparator, bin, binSibling);
                    } else {
                    ...
                    if (startedSplits) {
                        ...
                        if (lastParentForSplit != child.getNodeId()) {
                            final LogItem newChildItem =
                                child.optionalLogProvisional(parent);
                        ...
                        if (parent.isRoot()) {
                            ...
                            final long newRootLsn = parent.optionalLog().lsn;
            ...
            if (binSibling != null &&
                binSibling != binResult) {
                binSibling.releaseLatch();
            }
            ...
            if (binSibling != null) {
                binSibling.releaseLatchIfOwner();
            }
            if (rootIN != null) {
    ...
    private void splitRoot(CacheMode cacheMode)
        ...
        try {
            ...
            try {
                LogItem curRootItem = curRoot.optionalLogProvisional(newRoot);
                ...
                logLsn = newRoot.optionalLog().lsn;
                logSuccess = true;
            } finally {
                if (!logSuccess) {

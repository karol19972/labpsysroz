...
[ -f "$ORIENTDB_HOME"/lib/orientdb-tools-3.2.0.jar ] || ORIENTDB_HOME=`cd "$PRGDIR/.." ; pwd`
...
exec "$JAVA" -client $JAVA_OPTS $ORIENTDB_OPTS_MEMORY $ORIENTDB_SETTINGS $SSL_OPTS \
    -Dfile.encoding=utf-8 -Dorientdb.build.number="develop@rc08b76230798b477a8abbf2312b30ecddad842ad; 2021-04-29 10:51:13+0000" \
    -cp "$ORIENTDB_HOME/lib/orientdb-tools-3.2.0.jar:$ORIENTDB_HOME/lib/*:$ORIENTDB_HOME/plugins/*" \

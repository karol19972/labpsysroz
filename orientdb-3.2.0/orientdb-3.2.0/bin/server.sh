...
exec "$JAVA" $JAVA_OPTS \
    ...
    -Dorientdb.build.number="develop@rc08b76230798b477a8abbf2312b30ecddad842ad; 2021-04-29 10:51:13+0000" \
    -cp "$ORIENTDB_HOME/lib/orientdb-server-3.2.0.jar:$ORIENTDB_HOME/lib/*:$ORIENTDB_HOME/plugins/*" \
